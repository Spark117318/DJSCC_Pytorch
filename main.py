...
class JSCCNet(nn.Module):
    def __init__(self, P, snr_db, input_channels=3, output_channels=3, wireless_channel=19):
        ...
        self.conv4 = nn.Conv2d(32, 19, kernel_size=3, stride=1, padding=2)
        self.prelu4 = nn.PReLU()
        self.conv5 = nn.Conv2d(19, wireless_channel, kernel_size=3, stride=1, padding=2)
        ...
        # Decoder
        self.deconv1 = nn.ConvTranspose2d(wireless_channel, 19, kernel_size=3, stride=1, padding=2)
        self.prelu6 = nn.PReLU()
        self.deconv2 = nn.ConvTranspose2d(19, 32, kernel_size=3, stride=1, padding=2)
        self.prelu7 = nn.PReLU()
        self.deconv3 = nn.ConvTranspose2d(32, 32, kernel_size=3, stride=1, padding=2)
        self.prelu8 = nn.PReLU()
        self.deconv4 = nn.ConvTranspose2d(32, 16, kernel_size=5, stride=2, padding=0, output_padding=1)
